...
class ListChildrenCategoriesWithCountIncludingSubCategories implements ListChildrenCategoriesWithCount
{
    ...
    public function list(
        ...
        $categoryIdsInPath = null !== $categoryIdToFilterWith ?
            $this->fetchCategoriesBetween($categoryIdToExpand, $categoryIdToFilterWith) : [$categoryIdToExpand];

        return $this->getRecursivelyCategories($categoryIdsInPath, $translationLocale, $categoryIdToFilterWith);
    }
